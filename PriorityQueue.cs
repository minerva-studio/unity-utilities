...
namespace Minerva.Module
{
    ...
    ///     <para> This implementation is copied from .Net Library since it would be added to .Net 6 while unity sucks and use Standard 2.1 </para>
    /// </remarks>
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        {
            elements = elements ?? throw new ArgumentNullException();
                                                       ...
                                                       ICollection
        {
            ...
            {
                array = array ?? throw new ArgumentNullException();
