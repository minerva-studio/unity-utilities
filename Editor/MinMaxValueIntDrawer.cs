...
namespace Minerva.Module.Editor
{
    ...
    public class MinMaxValueIntDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var randomizeProp = property.FindPropertyRelative(nameof(MinMaxValueInt.randomize));
            var valueProp = property.FindPropertyRelative(nameof(MinMaxValueInt.value));
            var rangeProp = property.FindPropertyRelative(nameof(MinMaxValueInt.range));
            ...
            if (randomizeProp != null && randomizeProp.boolValue && rangeProp != null)
            {
                ...
                if (minProp != null && maxProp != null)
                {
                    ...
                    var newMax = EditorGUI.IntField(maxRect, max);
                    if (newMax != max) maxProp.intValue = newMax;
                }
            }
            else if (valueProp != null)
            {
                var value = valueProp.intValue;
                var newValue = EditorGUI.IntField(valueRect, value);
                if (newValue != value) valueProp.intValue = newValue;
            }
